    ...
    <div class="container">
        ...
        <div class="main-sidebar">
            ...
            <ul class="nav" >
                ...
                <div class="menu">
                    ...
                    <li><a href="?"><i class="ti-home nav-icon"></i>Trang chủ</a></li>
                    <li><a href="#id2"><i class="ti-video-camera nav-icon"></i>Tất cả phim</a></li>
                    <li><a href="#id3"><i class="ti-mobile nav-icon"></i>Liên hệ</a></li>
                ...
                <div class="sidebar-footer">
                    <li><a href="http://localhost/xemphim/login.php"><i class="ti-user nav-icon"></i>Đăng nhập</a></li>
                    <li><a href="http://localhost/xemphim/register.php"><i class="ti-pencil nav-icon"></i>Đăng ký</a></li>
                </div>
        ...
        <div class="main-content">
            ...
            <div id="header">
                ...
                <div class="user">
                    <a class="ann-infomation" href="http://localhost/xemphimOnline/login.php"><i class="header-icon ti-announcement"></i></a>
            ...
            <div id="slider">
                <div class="slider-container">
                    ...
                    <div class="slide active">
                        ...
                        <a onclick="showInfoToast()" class="caption" href="#">XEM PHIM</a>
                    </div>
            ...
            <div id="upcoming-movie">
                ...
                <div class="movie-grid">
                    ...
                    <div onclick="showInfoToast()" class="movie">
                        <a href="#">
